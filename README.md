...
Merge a pull request onto 'main' branch. In the settings for Pages, make sure the source is set to 'GitHub Actions'. Also, in App.jsx, make sure you use import.meta.env.BASE_URL which specifies the relative project URL. All this will deploy the site to the live URL:
